...
case class AmendClaimReceipt(response: AmendClaimResponse, answers: AmendAnswers) {
...
object AmendClaimReceipt {
  implicit val format: OFormat[AmendClaimReceipt] = Json.format[AmendClaimReceipt]
}

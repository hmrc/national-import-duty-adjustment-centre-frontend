...
object AmendCaseResponseType extends Enumerable.Implicits {
  ...
  case object SupportingDocuments extends WithValue("supportingDocuments") with AmendCaseResponseType
  case object FurtherInformation  extends WithValue("furtherInformation") with AmendCaseResponseType

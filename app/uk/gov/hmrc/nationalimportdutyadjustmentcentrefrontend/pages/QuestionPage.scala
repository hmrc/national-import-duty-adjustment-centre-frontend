...
case class ReclaimDutyTypePage()      extends QuestionPage[Set[ReclaimDutyType]]
case class CustomsDutyRepaymentPage() extends QuestionPage[DutyPaid]
case class ImportVatRepaymentPage()   extends QuestionPage[DutyPaid]
case class OtherDutyRepaymentPage()   extends QuestionPage[DutyPaid]
case object BankDetailsPage           extends QuestionPage[BankDetails]
case class ClaimReasonPage()          extends QuestionPage[ClaimReason]
case class UploadSummaryPage()        extends QuestionPage[Boolean]
case class EntryDetailsPage()         extends QuestionPage[EntryDetails]
case class ItemNumbersPage()          extends QuestionPage[ItemNumbers]
